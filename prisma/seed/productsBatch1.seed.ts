...
export const seedProducts = async (prisma: PrismaClient) => {
    ...
    await prisma.productItem.createMany({
        data: [
            { rootProductId: 1, size: '38.5', stock: 5, barcode: '2064831328908' },
            { rootProductId: 1, size: '39', stock: 10, barcode: '2003727259308' },
            { rootProductId: 1, size: '40', stock: 10, barcode: '2033813131140' },
            { rootProductId: 1, size: '40.5', stock: 3, barcode: '2094130898390' },
            { rootProductId: 1, size: '41', stock: 10, barcode: '2066857707071' },
            { rootProductId: 1, size: '42', stock: 15, barcode: '2020634989609' },
            { rootProductId: 1, size: '42.5', stock: 5, barcode: '2029098923891' },
            { rootProductId: 1, size: '43', stock: 10, barcode: '2079971399541' },
            { rootProductId: 1, size: '44', stock: 9, barcode: '2050978697489' },
            { rootProductId: 2, stock: 20, barcode: '2056261128586' },
            { rootProductId: 3, stock: 10, barcode: '2098049607548' },
            { rootProductId: 4, size: '29.5', stock: 5, barcode: '2028873302142' },
            { rootProductId: 4, size: '31', stock: 7, barcode: '2039272004865' },
            { rootProductId: 4, size: '32', stock: 7, barcode: '2018361638860' },
            { rootProductId: 4, size: '33', stock: 12, barcode: '2041076532581' },
            { rootProductId: 4, size: '33.5', stock: 5, barcode: '2015966093964' },
            { rootProductId: 4, size: '34', stock: 10, barcode: '2012252191793' },
            { rootProductId: 4, size: '35', stock: 8, barcode: '2076163825253' },
            { rootProductId: 5, size: '35', stock: 10, barcode: '2013103987145' },
            { rootProductId: 5, size: '36', stock: 20, barcode: '2084770243100' },
            { rootProductId: 5, size: '37', stock: 22, barcode: '2031859776134' },
            { rootProductId: 5, size: '38', stock: 18, barcode: '2008482275068' },
            { rootProductId: 5, size: '39', stock: 10, barcode: '2083088942972' },
            { rootProductId: 6, stock: 40, barcode: '2081206354041' },
            { rootProductId: 7, stock: 17, barcode: '2097921229649' },
            { rootProductId: 8, stock: 50, barcode: '2057738241838' },
            { rootProductId: 9, size: '35', stock: 20, barcode: '2097680724386' },
            { rootProductId: 9, size: '36', stock: 25, barcode: '2063179172877' },
            { rootProductId: 9, size: '37', stock: 28, barcode: '2074031787788' },
            { rootProductId: 9, size: '38', stock: 28, barcode: '2011410210314' },
            { rootProductId: 9, size: '39', stock: 15, barcode: '2079224231048' },
            { rootProductId: 10, size: '40', stock: 15, barcode: '2077135603053' },
            { rootProductId: 10, size: '41', stock: 12, barcode: '2012195283319' },
            { rootProductId: 10, size: '42', stock: 18, barcode: '2050110123395' },
            { rootProductId: 10, size: '43', stock: 18, barcode: '2024842556714' },
            { rootProductId: 10, size: '44', stock: 20, barcode: '2077572419576' },
            { rootProductId: 11, size: '42', stock: 30, barcode: '2087572767140' },
            { rootProductId: 11, size: '42.5', stock: 10, barcode: '2003205979797' },
            { rootProductId: 11, size: '43', stock: 20, barcode: '2072297159707' },
            { rootProductId: 11, size: '44', stock: 20, barcode: '2085267848211' },
            { rootProductId: 11, size: '44.5', stock: 10, barcode: '2040522091719' },
            { rootProductId: 12, size: '42', stock: 20, barcode: '2030681180836' },
            { rootProductId: 12, size: '43', stock: 22, barcode: '2035441815416' },
            { rootProductId: 12, size: '44', stock: 20, barcode: '2085126903020' },
            { rootProductId: 12, size: '44.5', stock: 16, barcode: '2010310407305' },
            { rootProductId: 13, size: '40', stock: 30, barcode: '2055493636999' },
            { rootProductId: 13, size: '40.5', stock: 13, barcode: '2081897701285' },
            { rootProductId: 13, size: '41', stock: 28, barcode: '2063665445256' },
            { rootProductId: 13, size: '42', stock: 30, barcode: '2080516471295' },
            { rootProductId: 13, size: '42.5', stock: 10, barcode: '2075507930028' },
            { rootProductId: 14, size: '38.5', stock: 12, barcode: '2051484062846' },
            { rootProductId: 14, size: '39', stock: 24, barcode: '2011004246156' },
            { rootProductId: 14, size: '40', stock: 20, barcode: '2014059336124' },
            { rootProductId: 14, size: '40.5', stock: 30, barcode: '2011547269469' },
            { rootProductId: 15, size: '41', stock: 24, barcode: '2063694680154' },
            { rootProductId: 15, size: '42', stock: 30, barcode: '2056066670686' },
            { rootProductId: 15, size: '42.5', stock: 12, barcode: '2063282074761' },
            { rootProductId: 15, size: '43', stock: 25, barcode: '2067918527362' },
            { rootProductId: 15, size: '44', stock: 30, barcode: '2071632033764' }
        ]
    })
