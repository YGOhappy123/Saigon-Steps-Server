...
export const seedProducts = async (prisma: PrismaClient) => {
    ...
    await prisma.productItem.createMany({
        data: [
            { rootProductId: 46, size: '39', stock: 8, barcode: '2057741327710' },
            { rootProductId: 46, size: '40', stock: 22, barcode: '2043381194492' },
            { rootProductId: 46, size: '40.5', stock: 9, barcode: '2087698893433' },
            { rootProductId: 46, size: '41', stock: 27, barcode: '2034321484360' },
            { rootProductId: 46, size: '42', stock: 25, barcode: '2004677250896' },
            { rootProductId: 46, size: '42.5', stock: 9, barcode: '2071863087697' },
            { rootProductId: 46, size: '43', stock: 23, barcode: '2090983192050' },
            { rootProductId: 47, size: '35', stock: 7, barcode: '2004705812713' },
            { rootProductId: 47, size: '36', stock: 15, barcode: '2044326637265' },
            { rootProductId: 47, size: '37', stock: 20, barcode: '2085634654377' },
            { rootProductId: 47, size: '38', stock: 24, barcode: '2037621941687' },
            { rootProductId: 47, size: '39', stock: 11, barcode: '2087774650462' },
            { rootProductId: 48, size: '35', stock: 12, barcode: '2024058849976' },
            { rootProductId: 48, size: '36', stock: 15, barcode: '2066678421309' },
            { rootProductId: 48, size: '37', stock: 20, barcode: '2021567833472' },
            { rootProductId: 48, size: '38', stock: 19, barcode: '2027499793433' },
            { rootProductId: 48, size: '39', stock: 10, barcode: '2093532459895' },
            { rootProductId: 49, stock: 6, barcode: '2003137049162' },
            { rootProductId: 50, stock: 3, barcode: '2090228216923' },
            { rootProductId: 51, stock: 50, barcode: '2081142795748' },
            { rootProductId: 52, stock: 30, barcode: '2062333215597' },
            { rootProductId: 53, size: '39', stock: 10, barcode: '2056717642826' },
            { rootProductId: 53, size: '40', stock: 15, barcode: '2093921558727' },
            { rootProductId: 53, size: '41', stock: 22, barcode: '2026888870366' },
            { rootProductId: 53, size: '42', stock: 24, barcode: '2056514766572' },
            { rootProductId: 53, size: '43', stock: 15, barcode: '2085751541499' },
            { rootProductId: 53, size: '44', stock: 10, barcode: '2075334719971' },
            { rootProductId: 54, size: '39', stock: 8, barcode: '2021982633664' },
            { rootProductId: 54, size: '40', stock: 15, barcode: '2045453976234' },
            { rootProductId: 54, size: '41', stock: 20, barcode: '2006151196911' },
            { rootProductId: 54, size: '42', stock: 22, barcode: '2067598821736' },
            { rootProductId: 54, size: '43', stock: 15, barcode: '2059450207475' },
            { rootProductId: 54, size: '44', stock: 10, barcode: '2006998508939' },
            { rootProductId: 55, size: '39', stock: 6, barcode: '2051496093586' },
            { rootProductId: 55, size: '40', stock: 15, barcode: '2021503874064' },
            { rootProductId: 55, size: '41', stock: 20, barcode: '2023094910992' },
            { rootProductId: 55, size: '42', stock: 28, barcode: '2075333635579' },
            { rootProductId: 55, size: '43', stock: 15, barcode: '2055396920089' },
            { rootProductId: 55, size: '44', stock: 10, barcode: '2037694456873' },
            { rootProductId: 56, stock: 50, barcode: '2004883640580' },
            { rootProductId: 57, stock: 50, barcode: '2007093968444' },
            { rootProductId: 58, size: '36', stock: 10, barcode: '2030285652524' },
            { rootProductId: 58, size: '37', stock: 22, barcode: '2095048155995' },
            { rootProductId: 58, size: '38', stock: 20, barcode: '2089843030588' },
            { rootProductId: 58, size: '39', stock: 12, barcode: '2089070592361' },
            { rootProductId: 59, size: '36', stock: 10, barcode: '2027834798475' },
            { rootProductId: 59, size: '37', stock: 27, barcode: '2036042436499' },
            { rootProductId: 59, size: '38', stock: 24, barcode: '2062800812274' },
            { rootProductId: 59, size: '39', stock: 4, barcode: '2061786658562' },
            { rootProductId: 60, stock: 14, barcode: '2057602291907' }
        ]
    })
