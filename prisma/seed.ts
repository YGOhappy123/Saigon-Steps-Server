    ...
    await prisma.shoeFeature.createMany({
        data: [
            ...
            },
            {
                ...
                categoryId: 4,
                gender: ShoeGender.MALE,
                upperMaterial: 'Da tổng hợp cao cấp chống nhăn',
                soleMaterial: 'Cao su tổng hợp chống trượt',
                liningMaterial: 'Da nhân tạo mềm mại thấm hút tốt',
            ...
            },
            {
                ...
                upperMaterial: 'Da tổng hợp cao cấp',
                soleMaterial: 'Cao su tổng hợp chống trượt',
                liningMaterial: 'Da nhân tạo mềm mại thoáng khí',
                closureType: 'Trượt (slip-on)',
                toeShape: 'Bo tròn kiểu mocassin',
                waterResistant: 'Có khả năng kháng nước nhẹ',
                breathability: 'Tốt',
            ...
            },
            {
                ...
                categoryId: 4,
                gender: ShoeGender.MALE,
                upperMaterial: 'Da tổng hợp cao cấp chống nhăn và bóng nhẹ',
                soleMaterial: 'Cao su tổng hợp chống trượt',
                liningMaterial: 'Da nhân tạo mềm mại thấm hút mồ hôi',
                closureType: 'Trượt (slip-on)',
            ...
            },
            {
                ...
                categoryId: 2,
                gender: ShoeGender.MALE,
                upperMaterial: 'Vải nylon chống nước kết hợp da tổng hợp',
                soleMaterial: 'Cao su chống trượt bền bỉ',
                liningMaterial: 'Vải tổng hợp thoáng khí',
            ...
            },
            {
                ...
                categoryId: 2,
                gender: ShoeGender.MALE,
                upperMaterial: 'Vải dệt tổng hợp kết hợp da PU',
                soleMaterial: 'Cao su chống trượt bền bỉ',
                liningMaterial: 'Vải tổng hợp thoáng khí',
                closureType: 'Dây Velcro điều chỉnh được',
                toeShape: 'Mở rộng (open-toe)',
            ...
            },
            {
                ...
                categoryId: 2,
                gender: ShoeGender.MALE,
                upperMaterial: 'Vải nylon chống nước kết hợp da PU cao cấp',
                soleMaterial: 'Cao su chống trượt, bền bỉ với thiết kế rãnh sâu',
                liningMaterial: 'Vải tổng hợp mềm mại và thoáng khí',
            ...
            },
            {
                ...
                categoryId: 2,
                gender: ShoeGender.MALE,
                upperMaterial: 'Vải dệt nylon kết hợp da tổng hợp cao cấp',
                soleMaterial: 'Cao su chống trượt bền bỉ',
                liningMaterial: 'Vải tổng hợp thoáng khí',
                closureType: 'Dây Velcro điều chỉnh được',
                toeShape: 'Mở rộng (open-toe)',
            ...
            },
            {
                ...
                categoryId: 2,
                gender: ShoeGender.MALE,
                upperMaterial: 'Da tổng hợp cao cấp chống trầy xước',
                soleMaterial: 'Cao su chống trượt, bền bỉ với thiết kế rãnh sâu',
                liningMaterial: 'Vải tổng hợp mềm mại và thoáng khí',
